            ...
            <div>
                <div>
                    <div style={{ width: '1250px' }}>
                        <header className="custom-header" >
                            <h1>INTRANET-DTDS</h1>
                            <h1 style={{ marginLeft: '400px' }}>Servicio de Gestion de Analisis de Datos</h1>
                ...
                <footer className="footer">
                    <div className="footer-bottom">
                        <p>Seccion de gestion Financiera de nuestro sistema interno de la empresa DATATECH DEEP SOLUTION</p>
                    </div>
                </footer>
                </div>
            </div>
